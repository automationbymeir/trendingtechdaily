...
exports.createArticle = async (articleData) => {
  try {
    const article = {
      ...
      sources: getSafe(() => articleData.sources, []),
      socialMentions: getSafe(() => articleData.socialMentions, []),
...
exports.updateArticle = async (articleId, articleData) => {
  try {
    const articleUpdate = {
      ...
      sources: getSafe(() => articleData.sources, undefined),
      socialMentions: getSafe(() => articleData.socialMentions, undefined),
